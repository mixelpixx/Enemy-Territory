...
UNIFORM_DEF(UNIFORM_DELUXEMAP, u_DeluxeMap, GLSL_INT)   // RM/R2-6
...
UNIFORM_DEF(UNIFORM_B_SHOW_DELUXEMAP, SHOW_DELUXEMAP, GLSL_BOOL)   // RM/R2-6
...
TEX_DEF(TEX_DELUXE, UNIFORM_DELUXEMAP)   // RM/R2-6
